...
class NotesSubState extends MusicBeatSubstate
{
	...
	public function new() {
		...
		#if DISCORD_ALLOWED
		DiscordClient.changePresence("Menú de colores de Notas", null);
		#end
		...
		var tipX = 20;
		var tipY = 660;
		var tip:FlxText = new FlxText(tipX, tipY, 0, "Presiona RELOAD para reiniciar la parte de la nota seleccionada.", 16);
	...
	function updateTip()
	{
		tipTxt.text = 'Mantén ' + (!controls.controllerMode ? 'Shift' : 'Botón del hombro izquierdo') + ' Presiona RESET para reiniciar la nota seleccionada por completo.';
	}
