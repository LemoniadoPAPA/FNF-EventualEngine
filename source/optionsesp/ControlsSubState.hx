...
class ControlsSubState extends MusicBeatSubstate
{
	...
	var options:Array<Dynamic> = [
		[true, 'NOTAS'],
		[true, 'Izquierda', 'note_left', 'Note Left'],
		[true, 'Abajo', 'note_down', 'Note Down'],
		[true, 'Arriba', 'note_up', 'Note Up'],
		[true, 'Derecha', 'note_right', 'Note Right'],
		[true],
		[true, 'UI'],
		[true, 'Izquierda', 'ui_left', 'UI Left'],
		[true, 'Abajo', 'ui_down', 'UI Down'],
		[true, 'Arriba', 'ui_up', 'UI Up'],
		[true, 'Derecha', 'ui_right', 'UI Right'],
		[true],
		[true, 'Reiniciar', 'reset', 'Reset'],
		[true, 'Aceptar', 'accept', 'Accept'],
		[true, 'Atrás', 'back', 'Back'],
		[true, 'Pausa', 'pause', 'Pause'],
		[false],
		[false, 'VOLÚMEN'],
		[false, 'Silenciar', 'volume_mute', 'Volume Mute'],
		[false, 'Subir', 'volume_up', 'Volume Up'],
		[false, 'Bajar', 'volume_down', 'Volume Down'],
		[false],
		[false, 'DEBUG'],
		[false, 'Tecla 1', 'debug_1', 'Debug Key #1'],
		[false, 'Tecla 2', 'debug_2', 'Debug Key #2']
	];
	var curOptions:Array<Int>;
	var curOptionsValid:Array<Int>;
	static var defaultKey:String = 'Reiniciar la Configuración';
	...
	public function new()
	{
		...
		#if DISCORD_ALLOWED
		DiscordClient.changePresence(" Menú de Controles", null);
		#end
