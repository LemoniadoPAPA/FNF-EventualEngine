...
class PauseSubStateEsp extends MusicBeatSubstate
{
	var grpMenuShit:FlxTypedGroup<Alphabet>;

	var menuItems:Array<String> = [];
	var menuItemsOG:Array<String> = ['Seguir', 'Reiniciar Canción', 'Cambiar Dificultad', 'Opciones', 'Salir al Menú'];
	...
	override function create()
	{
		...
		{
			menuItemsOG.insert(2, 'Salir del Modo Charting');
		...
		var chartingText:FlxText = new FlxText(20, 15 + 101, 0, "MODO CHARTING", 32);
