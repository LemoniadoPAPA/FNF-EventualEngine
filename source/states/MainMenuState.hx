...
class MainMenuState extends MusicBeatState
{
	...
	var side:FlxSprite = new FlxSprite(0).loadGraphic(Paths.image('side'));
	...
	override function create()
	{
		...
		switch(ClientPrefs.data.menuType)
		{
			...
			case 'Dark':
				...
				magenta = new FlxSprite(-80).loadGraphic(Paths.image('menuBlack'));
				side.visible = true;
				checker.visible = true;
			/*case 'Classic': moved to a state cuz i didn't know what x value should i put lol (Lemoniado)
				side.visible = false;
				checker.visible = false;
				menuItemX = 404;*/
			/*case 'Lemoniado Mod': Unused
				bg.loadGraphic(Paths.image('menuBGLemo'));
				side.loadGraphic(Paths.image('Lemomod_Side'));
				menuItemX = 110;
				menuItemAngle = -6.5;*/
		}
				...
				else*/
				{
					...
					FlxFlicker.flicker(menuItems.members[curSelected], 1, 0.06, false, false, function(flick:FlxFlicker)
					{
						switch (optionShit[curSelected])
						{
							...
							case 'credits':
								CreditsState.inMainMenuState = true;
								CreditsStateEspanol.inMainMenuState = true;
							...
							case 'options':
								...
								OptionsState.onMainMenuState = true;
