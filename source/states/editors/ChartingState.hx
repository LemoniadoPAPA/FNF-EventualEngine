...
class ChartingState extends MusicBeatState
{
	...
	[
		...
		//['White BG', "Value 1: toggle/true to activate, desactivate/false to desactivate. Value 2 are the Fade Speed"],
		//['Add Animated Camera Zoom', "Value 1 is the zoom that you want. Value 2 is the speed\nLeave value 1 blank to use default zoom"], shitty animated cam zoom
		//['Set Lyrics', "Value 1 is the text that you want"],
		//['Add Animated Cam Zoom', "Value 1 is the zoom that you want. Value 2 is the speed\nLeave value 1 blank to use default zoom"],
		['Fast Car Pass', "For Mom's songs.\nLeave values in blank for make it work."],
		['Flash Camera', "Just leave the values in blank."],
		//['Foreground Alpha', "Value 1 is the Alpha (put 0.0001 to make it invisible).\nValue 2 is the Speed. \nOnly use in \"tank\" stage"],
		['Set Animated Zoom', "Value 1 is the zoom that you want.\nValue 2 is the speed of the animation"],
		['BF Fade', "Value 1 is the Alpha (put inv to make it invisible).\nValue 2 is the Speed."],
		['GF Fade', "Value 1 is the Alpha (put inv to make it invisible).\nValue 2 is the Speed."],
		['Opponent Fade', "Value 1 is the Alpha (put inv to make it invisible).\nValue 2 is the Speed."],
		['Toggle HUD', "Value 1 is the alpha, put \"inv\" to make it invisible. Value 2 is the Fade Speed."],
		['Set Overlay', "Value 1 is the Overlay Alpha, put \"inv\" to make it invisible. Value 2 is\n the Fade Speed."],
		['Set Red Overlay', "Value 1 is the Overlay Alpha, put \"inv\" to make it invisible. Value 2 is\n the Fade Speed."],
		['Set Green Overlay', "Value 1 is the Overlay Alpha, put \"inv\" to make it invisible. Value 2 is\n the Fade Speed."],
		['Set Blue Overlay', "Value 1 is the Overlay Alpha, put \"inv\" to make it invisible. Value 2 is\n the Fade Speed."],
		['Set Yellow Overlay', "Value 1 is the Overlay Alpha, put \"inv\" to make it invisible. Value 2 is\n the Fade Speed."],
		//['Set Cutscene Bars', "Value 1 is the Bars Alpha, put \"inv\" to make it invisible. Value 2 is\n the Fade Speed."],
