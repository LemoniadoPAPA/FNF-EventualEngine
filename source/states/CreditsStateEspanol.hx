...
class CreditsStateEspanol extends MusicBeatState
{
	...
	public static var inMainMenuState:Bool = false;
	...
	override function create()
	{
		...
		var defaultList:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			['Eventual Engine Team'],
			['Lemoniado',		'lemo',		'Main Programmer of Eventual Engine',					 'https://www.youtube.com/channel/UCmdcI4Ma8ZWDnG10QWlUv8g',		'EFB904'],
			['Special Thanks'],
			['LeonGamerPS4',		'none',		'Unknown Engine creator (Extra Data Code Base)',								'https://gamebanana.com/mods/383504',	'C10A15'],
			['RanBanana',		'none',		'Ice Engine Creator (Watermark Code Base)',								'https://gamebanana.com/mods/404690',	'0AB3C1'],
			//['KadeDev',		'none',		'Kade Engine Creator (Some stuff on Title Menu)',								'https://gamebanana.com/mods/44291',	'64A250'],
			['Psych Engine Team'],
