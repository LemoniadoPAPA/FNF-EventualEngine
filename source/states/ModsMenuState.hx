...
//import optionsesp.ModSettingsSubState;
import optionseng.ModSettingsSubState;
...
class ModsMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var modCompatibleText:FlxText = new FlxText(12, FlxG.height - 24, 0, "This mod is compatible with older PE (Just for event thingies)", 12);
		modCompatibleText.scrollFactor.set();
		modCompatibleText.setFormat("VCR OSD Mono", 16, FlxColor.WHITE, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		//add(modCompatibleText);

		/*var modNonCompatibleText:FlxText = new FlxText(12, FlxG.height - 24, 0, "This mod ISN'T compatible with older PE (Just for event thingies)", 12);
		modNonCompatibleText.scrollFactor.set();
		modNonCompatibleText.setFormat("VCR OSD Mono", 16, FlxColor.WHITE, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		add(modNonCompatibleText);*/
	...
	function updateModDisplayData()
	{
		...
		//modRestartText.visible = curMod.basePeComp; Unfinished
...
class ModItem extends FlxSpriteGroup
{
	...
	//public var basePeCompatible:Bool = false;
	...
	public function new(folder:String)
	{
		...
		if(pack != null)
		{
			...
			//this.basePeCompatible = (pack.basePeComp == true);
		}
		text.text = this.name;
