...
class DiscordClient
{
	...
	private static final _defaultID:String = "1211864057041264732";
	...
	public static function changePresence(?details:String = 'In the Menus', ?state:Null<String>, ?smallImageKey : String, ?hasStartTimestamp : Bool, ?endTimestamp: Float)
	{
		...
		presence.largeImageKey = 'Eventual Engine';
		presence.largeImageText = "Engine Version: " + states.MainMenuState.eventualEngineVersion;
